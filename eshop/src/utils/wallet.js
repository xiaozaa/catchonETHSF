...
import { isMobile, objectMap, formatWalletAddress } from "./utils.js";
...
export async function disconnectWalle() {
  await provider.off("disconnect");
...
//TODO: add a event listen when there is an account swtich, we should reset the UI
